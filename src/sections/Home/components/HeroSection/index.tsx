...
export default function HeroSection() {
	return (
		<motion.div initial="hidden" animate="show" variants={container} className="mastHead">
			<motion.img variants={motionItem} className="profileImage" src={ProfileImage} alt="" />
